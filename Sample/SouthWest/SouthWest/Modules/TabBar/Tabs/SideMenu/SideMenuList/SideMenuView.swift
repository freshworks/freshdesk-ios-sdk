...
struct SideMenuView: View {
    ...
    var body: some View {
        VStack (spacing: 0) {
            ...
            ScrollView {
                VStack (alignment: .leading) {
                    ...
                    Text("\(Constants.SideMenu.SDKVersionTitle)\(Freshdesk.getSDKVersion())")
        ...
        .onReceive(NotificationCenter.default.publisher(for: Notification.Name(rawValue: FDEvents.unreadCount.rawValue))) { notification in
